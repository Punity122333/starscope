...
const SignupSection = () => {
  ...
  if (typeof window !== "undefined") {
    const styleId = "signup-spinner-keyframes";
  ...
  return (
    ...
    >
      ...
      `}</style>
        ...
        {success && (
          <p style={{ color: "#64ffda", marginTop: "1.5rem", textAlign: "center" }}>Signup successful! Check your email to confirm.</p>
        )}
      </div>
    </section>
  );
